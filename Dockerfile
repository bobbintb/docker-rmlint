...
#rmlint install
RUN apt-get update
RUN apt-get install -y --no-install-recommends git scons python3-sphinx python3-nose gettext build-essential
...
RUN apt-get install -y --no-install-recommends python3-gi gir1.2-rsvg gir1.2-gtk-3.0 python-cairo gir1.2-polkit-1.0 gir1.2-gtksource-3.0
